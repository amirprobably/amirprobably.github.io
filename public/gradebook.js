// TODO: Fetch data from the PostgreSQL database (to be implememented later)
...
function fetchGradeData() {
	// This function will quert the PostgreSQL database and return grade data
	console.log("Fetching grade data...");
	...
	xhr.onreadystatechange = function(){
		...
		if(xhr.readyState === xhr.DONE){
			...
			// And then call the function to update HTML with our data
...
function populateGradebook(data) {
	...
	let tableElm = document.getElementById("gradebook"); // Get the gradebook table element
		data.forEach(function(assignment){ // For each row of data we're passed in
			...
			columns.name = document.createElement('td'); // The first columns's table data will be the name
			...
			columns.grade.appendChild(
				// just put the anme in text, you could be fancy and figure out the letter grade here
...
//TODO REMOVE THIS
//Call the stubs to demonstrade the workflow
